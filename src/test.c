// ce programme est l'une des sources présentent dans les commentaires de pgmImageProcessing
// je l'ai un peu modifié et utilisé pour comprendre comment traiter des images pgm
